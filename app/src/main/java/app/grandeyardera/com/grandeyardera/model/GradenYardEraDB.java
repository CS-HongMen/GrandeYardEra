...
public class GradenYardEraDB {
     ...
     * 将构造方法私有化
     */
    public GradenYardEraDB(Context context) {
    ...
    public String[] loadEmailPassword() {
        ...
        user.setUserEmail(cursor.getString(cursor.getColumnIndex("user_email")));
        user.setUserPassword(cursor.getString(cursor.getColumnIndex("user_password")));
        emailPassword[0] = user.getUserEmail();
        emailPassword[1] = user.getUserPassword();
        return emailPassword;
    }
    public void clearPassword(String newPassword){
